...
public class SpAdapter extends BaseAdapter {
    private List<GetWarehouseListEntity> getWarehouseListEntitys;
    private Context mContext;

    public SpAdapter(List<GetWarehouseListEntity> getWarehouseListEntitys, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            tv.setText(getWarehouseListEntitys.get(position).getWAREHOUSENAME());
        }
        return convertView;
    }
}
